...
//nut (1/8, 1/4, 3/8, 1/128, 32, 0, "metric", 28);

nut (10, 5 , 7, 0.15, 32, 0, "metric", 1.025);
...
module nut (height, thread_d, size, tolerance, quality, bool_cut, thread, pitch) {
    difference () {
        $fn = 16; // 6:would make it "hex" but we need it almost round 
